...
// ─── Shared Context Pressure ─────────────────────────────────────────────────
// Written by evolve module, read by other modules to self-limit under pressure.
export const contextPressure = { level: 0 }; // 0-1, updated every inject cycle
