...
Before ANY commit or push, check the current branch:
...
- `main`, `master`, `production`, `prod`, `develop`, `development`, `dev`
- `staging`, `release/*`, `hotfix/*`
...
- Use `--force-with-lease` only on your own feature branches
